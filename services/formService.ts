...
const MOCK_FORMS: Record<string, FormSchema> = {
    ...
    sections: [
      {
        ...
        fields: [
          ...
          },
          {
            ...
            placeholder: "alex.rivera@cs.mit.edu",
            type: "email",
            required: true,
            gridColumn: "half",
          },
          {
            ...
            placeholder: "Neural Vector Labs",
            type: "text",
            required: true,
            gridColumn: "half",
          },
          {
            ...
            label: "GitHub Organization / Profile URL",
  ...
  "research-symposium": {
    ...
    submitButtonText: "Submit Research Manuscript",
